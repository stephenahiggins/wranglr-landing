...
const Pricing = () => {
  ...
  return (
    <section className={`bg-background`} id="pricing">
      <div className={`container mx-10 px-2 pt-4 pb-12 text-primary`}>
        <h1
        ...
        <div className={`w-full mb-4`}>
          <div
            className={`h-1 mx-10 bg-primary w-64 opacity-25 my-0 py-0 rounded-t`}
          ></div>
        </div>
        <div
        ...
        >
          <div
            className={`flex flex-col w-5/6 lg:w-1/4 mx-10 lg:mx-0 rounded-none lg:rounded-l-lg bg-background mt-4`}
          >
            <div
          ...
          <div
            className={`flex flex-col w-5/6 lg:w-1/3 mx-10 lg:mx-0 rounded-lg bg-background mt-4 sm:-mt-6 shadow-lg z-10`}
          >
            <div
          ...
          <div
            className={`flex flex-col w-5/6 lg:w-1/4 mx-10 lg:mx-0 rounded-none lg:rounded-l-lg bg-primary mt-4`}
          >
            <div
              className={`flex-1 bg-background text-gray-600 rounded-t rounded-b-none overflow-hidden shadow`}
            >
